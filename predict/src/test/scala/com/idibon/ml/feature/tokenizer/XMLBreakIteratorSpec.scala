...
class XMLBreakIteratorSpec extends FunSpec with Matchers {

  val breakIterator = new ThreadLocal[XMLBreakIterator]() {
    override def initialValue() = new XMLBreakIterator(
